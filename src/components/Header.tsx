...
export default function Header (props: IHeaderProps) {
  return (
    <div className='flex flex-col gap-5  justify-between py-10 w-[40%] md:flex-row md:items-center md:w-full '>
      ...
      <Link href={"#contactSection"} className=' border-[2px] border-white rounded-sm p-2 hover:text-black hover:bg-white font-semibold ease-in-out transition-all'>Contact US</Link>
    </div>
  );
}
